...
NSString *const ReceiveTurnEventForMatch = @"receive_turn_event_for_match";


@interface GameKitHelper()<GKGameCenterControllerDelegate, GKLocalPlayerListener>
@end
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:ReceiveTurnEventForMatch
                                                        object:self];

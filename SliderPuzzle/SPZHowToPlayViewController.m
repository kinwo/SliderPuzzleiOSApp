...
-(void)buildIntro
{
    ...
    MYIntroductionPanel *panel2 = [[MYIntroductionPanel alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height) title:@"Get Hints" description:@"Touch & hold on 'Peek' button to get hints." image:[UIImage imageNamed:@"TourTheApp1"]];
    [self updatePanelUI:panel2];
    
    MYIntroductionPanel *panel3 = [[MYIntroductionPanel alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height) title:@"Play all levels" description:@"Tap 'More' button to switch to new levels." image:[UIImage imageNamed:@"TourTheApp1"]];
    [self updatePanelUI:panel3];

    MYIntroductionPanel *panel4 = [[MYIntroductionPanel alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height) title:@"No score but a timer." description:@"Yes. We don't count your scores but we show you the Timer!" image:[UIImage imageNamed:@"TourTheApp1"]];
    [self updatePanelUI:panel4];
    
    MYIntroductionPanel *panel5 = [[MYIntroductionPanel alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height) title:@"Ready?" description:@"Enjoy playing Squarez!" image:[UIImage imageNamed:@"TourTheApp1"]];

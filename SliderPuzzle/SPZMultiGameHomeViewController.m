...
@interface SPZMultiGameHomeViewController() <GKTurnBasedMatchmakerViewControllerDelegate>

@end

@implementation SPZMultiGameHomeViewController
...
- (IBAction)createNewSinglePlayerGame:(id)sender
{
    ...
    SPZGameBoardViewController *gameBoardVC = [self.storyboard instantiateViewControllerWithIdentifier:@"GameBoardVC"];
...
{
    [[SPZAlertPresenter sharedInstance] showAlertMessage:message];
}
